...
gallery/qrcode/1.1/index

*/
/**
 * @fileoverview 请修改组件描述
 * @author 拔赤<bachi@taobao.com>
 *         棪木<yanmu.wj@taobao.com>
 * @module qrcode
 **/
KISSY.add('gallery/qrcode/1.1/index',function (S, Node,Base) {
    ...
    (function () {
        ...
        QRCode = function (el, vOption) {
            ...
            this._oQRCode = null;
            this._oDrawing = new Drawing(this._elWrapper, this._htOption);
            
            if (this._htOption.text) {
                this.makeCode(this._htOption.text);	
            }

            if (this._htOption.icon) {
                this.makeIcon(this._htOption.icon);	
            }
        };
         ...
         * @private
         */
        QRCode.prototype.makeIcon = function (src) {
            var elIconWrapper = document.createElement("div"),
                elIcon = document.createElement("img");

            elIconWrapper.style.position = "absolute";
            elIconWrapper.style.left = elIconWrapper.style.top = "50%";
            elIcon.style.marginLeft = elIcon.style.marginTop = "-50%";
            elIcon.src = src;

            elIconWrapper.appendChild(elIcon);
            this._elWrapper.appendChild(elIconWrapper);
        };
